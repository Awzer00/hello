...
},beforePageText:"第",afterPageText:"/{pages}页",displayMsg:"{from}-{to}共{total}",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,firstDay:0,weeks:["日","一","二","三","四","五","六"],months:["一月","二月","三月","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:(function(){
var d=new Date();
